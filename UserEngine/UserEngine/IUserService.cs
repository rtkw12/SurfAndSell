...
public interface IUserService : IMongoService
{
    ...
    Task<TryResult> TryUpdateUser(IClientSessionHandle sessionHandle, CancellationToken cancellationToken, string id,
        string? name = null, string? email = null, string? password = null, UserType type = UserType.CUSTOMER);
